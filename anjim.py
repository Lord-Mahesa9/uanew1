...
class crack:
	...
	def crack(self,user,lala,asu):
		...
		ua=awokawok(["Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
		       awokawok(["Nokia6280/2.0 (03.60) Profile/MIDP-2.0 Configuration/CLDC-1.1 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia7610/2.0 (5.0509.0) SymbianOS/7.0s Series60/2.1 Profile/MIDP-2.0 Configuration/CLDC-1.0[FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; 909) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia205/2.0 (04.71) Profile/MIDP-2.1 Configuration/CLDC-1.1 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Linux; U; Android 4.2; ru-ru; Nokia_X Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.2 Mobile Safari/E7FBAF [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Symbian/3; Series60/5.2 NokiaN8-00/012.002; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/533.4 (KHTML, like Gecko) NokiaBrowser/7.3.0 Mobile Safari/533.4 3gpp-gba [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaC3-00/5.0 (07.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (MeeGo; NokiaN9) AppleWebKit/534.13 (KHTML, like Gecko) NokiaBrowser/8.5.0 Mobile Safari/534.13 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaX2-01/5.0 (08.65) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.82 Mobile Safari/537.36 NokiaBrowser/1.2.0.12 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaC3-00/5.0 (08.65) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia5250/10.0.011 (SymbianOS/9.4; U; Series60/5.0 Mozilla/5.0; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Safari/525 3gpp-gba [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (SymbianOS/9.3; U; Series60/3.2 Nokia5630d-1/011.018; Profile/MIDP-2.1 Configuration/CLDC-1.1)<br>AppleWebKit/413 (KHTML, like Gecko)<br>Safari/413 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaC6-00/10.0.021 (SymbianOS/9.4; Series60/5.0 Mozilla/5.0; Profile/MIDP-2.1 Configuration/CLDC-1.1) AppleWebkit/525 (KHTML, like Gecko) BrowserNG/7.2.6 UNTRUSTED/1.0 3gpp-gba [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaC3-00/5.0 (07.80) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Maemo; Linux; Jolla; Sailfish; Mobile) AppleWebKit/534.13 (KHTML, like Gecko) NokiaBrowser/8.5.0 Mobile Safari/534.13
               awokawok(["NokiaC3-00/5.0 (07.20) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaC1-01/2.0 (06.15) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 (Java; U; en-us; nokiac1-01) UCBrowser8.3.0.154/69/444/UCWEB Mobile UNTRUSTED/1.0 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Maemo; Linux; Jolla; Sailfish; Mobile) AppleWebKit/537.36 (KHTML, like Gecko) NokiaBrowser/8.5.0 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia2700c-2/2.0 (07.80) Profile/MIDP-2.1 Configuration/CLDC-1.1 UNTRUSTED/1.0 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["NokiaN86_8MP/GoBrowser/1.6.0.4868.208.92; [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia5320XpressMusic/GoBrowser/1.6.0.75 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia6303classic/2.0 (06.40) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia6303classic/2.0 (10.12) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia112/2.0 (03.48) Profile/MIDP-2.1 Configuration/CLDC-1.1 UNTRUSTED/1.0 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia113/2.0 (03.47) Profile/MIDP-2.1 Configuration/CLDC-1.1 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia6280/2.0 (03.60) Profile/MIDP-2.0 Configuration/CLDC-1.1 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia7610/2.0 (5.0509.0) SymbianOS/7.0s Series60/2.1 Profile/MIDP-2.0 Configuration/CLDC-1.0 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; 909) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
               awokawok(["Nokia205/2.0 (04.71) Profile/MIDP-2.1 Configuration/CLDC-1.1 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]",open("ua","r").read()])
